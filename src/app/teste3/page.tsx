...
export default function FloatingActionButtons() {
  const [currentIcon, setCurrentIcon] = React.useState(<TagFacesIcon 
    sx={{ 
      color: '#475569', 
      fontSize: 50, 
      position: 'absolute', 
  ...
  const handleChangeIcon = () => {
    setCurrentIcon(prevIcon => {
      ...
      } else if (prevIcon.type === SentimentNeutralOutlinedIcon) {
  ...
  return (
    <div className="h-screen flex flex-col justify-between items-center bg-white" style={{ backgroundColor:'#F8F9FD'}}>
      ...
      <div className="relative">
        <div className="bg-white flex flex-center justify-center items-center mt-80 w-screen" style={{ backgroundColor:'#F8F9FD'}} onClick={handleChangeIcon}>
